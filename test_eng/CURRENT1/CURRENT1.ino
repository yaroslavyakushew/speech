...
MyServo kleshnya(16, 0, 10, 80);
MyServo kist_rotary(5, 0, 150, 80); //Крутить кулачок
MyServo kist_bend(4, 0, 150, 80); //Локоть
MyServo shoulder(0, 20, 200, 80);
MyServo collarbone(14, 0, 100, 80); //Основание
